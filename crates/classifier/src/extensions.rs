...
pub fn extension_weights() -> ExtWeights {
    ...
    m.insert(
        ...
        vec![
            (Category::Music, 0.7),
            (Category::Audiobook, 0.2),
            (Category::Course, 0.1),
        ],
    );
    m.insert(
        ".flac",
        vec![(Category::Music, 0.9), (Category::Audiobook, 0.1)],
    );
    m.insert(
        ".m4a",
        vec![
            (Category::Music, 0.5),
            (Category::Audiobook, 0.4),
            (Category::Course, 0.1),
        ],
    );
    ...
    m.insert(
        ".exe",
        vec![(Category::Software, 0.6), (Category::Game, 0.4)],
    );
    m.insert(
        ".msi",
        vec![(Category::Software, 0.8), (Category::Game, 0.2)],
    );
    m.insert(
        ".dmg",
        vec![(Category::Software, 0.8), (Category::Game, 0.2)],
